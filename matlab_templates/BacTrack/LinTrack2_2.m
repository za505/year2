...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%User Input
basename='02102021_pbs10_colony1';%Name of the image stack, used to save file.
...
dirname=['/Users/zarina/Downloads/NYU/Year2_2021_Spring/pbs_analysis2/02102021_pbs10/' basename '/' basename '_erased'];%_cell1
...
thresh=9252;%Threshold used to enhance contrast. Default:35000 %set to 2000
thresh2=0.002;%Threshold used in edge finder. Default:0.01, 0.001 seems to 
% work better for me
...
for i=1:27 %length of cell id
    for j=1:25 %number of cells
        for k=1:25 %number of cells
